...
url = f"https://api.sportradar.com/mlb/trial/v7/en/league/venues.{response_format}?api_key={mlb_key}"
...
dbutils.fs.put(f"abfss://bronze@mlbanalysisucexternaldl.dfs.core.windows.net/venue/stadium_info.json", json_str, overwrite=True)
